...
row2 <- plot_grid(plot_spacer(), p_comb, plot_spacer(), ncol=3, rel_widths=c(1,1,1))
...
- Para un set de hyperparámetros el modelo describe una familia de funciones y de parámetros que determinan el modelo en particular 

## ¿Qué es un hyperparámetro?
- Podemos re-entrenar con otros parámetros... recordemos: optimización de hyperparámetros o busqueda de hyperparámetros. 
- Tomando en cuenta los hyperparámetros la red representa una familia de familias que relacionan los inputs con los outputs 
