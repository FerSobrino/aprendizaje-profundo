...
- Semana 1-4: Fundamentos 
    ...
    - Regularización 
- Semana 5-7: CNNs y RNNs
- Semana 8-10: Transformers 
- Semana 11: ¿Por qué funciona el aprendizaje profundo?/ Fairness/Etica y preguntas abiertas 


## Evaluación
- 8 tareas, las tareas incluyen preguntas teoricas y de python (60%)
- OJO: No esta permitido el uso de LLMs, pueden buscar en google (sin Gemini), en stackoverflow, en libros, blogposts, la documentación de python, trabajar con sus compañeros etc 
- 1 presentación de un paper de DL en parejas (40%)
- Los papers se van a asignar de manera aleatoria 
- Las características de las presentaciones estan en un markdown que pueden consultar 
...
- Recordemos la diferencia entre la predicción y el valore real lo cauntificamos utilizando una función de perdida, escalar que nos dice que tan bien esta ajustando el modelo a los datos de entrenamiento
...
1. Segmentación de Imagenes
2. Estimación de profundidad
3. Estimación de pose 
4. Traducción
5. Ponerle Caption a las imagenes
6. Generar imagenes del texto 
...
- Ejemplo: 
    ...
    - Las imagenes tienen que tener cierto sentido, hay combinaciones de pixeles que no significan nada 
    
## Aprendizaje No-Supervisado
- Para resolver estos problemas necesitamos alejarnos del aprendizaje supervisado 
- La idea es aprender por ejemplo la estructura gramatical de los datos de entrenamiento sin darsela explicitamente al modelo 
...
- **Menos ingeniería manual:** evitan el costoso y el sesgo de diseñar features a mano (SIFT, TF–IDF, etc.).  
