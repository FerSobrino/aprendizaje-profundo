...
![](../Imagenes/red_gradientes.png){fig-align="center" width="80%"}
...
## Ejemplo sencillo: backward pass
![](../Imagenes/backwardpass.png){fig-align="center" width="80%"}


## Ejemplo en forma vectoria/matricial de backprop
- Tenemos la siguiente red
![](../Imagenes/redbackprop.png){fig-align="center" width="80%"}
...
- Pero casi todas estas parciales son relativamente sencillas: 
    ...
    - Si las funciones de activación son ReLU $max(0,x)$ entonces $\frac{\partial h_3}{\partial f_2} = \frac{\partial a}{\partial f_2} = \mathbb{I}[f_2 >0]$
...
- Comenzamos con la parcial $\frac{\partial ℓ_i}{\partial f_k}$ y nos movemos en reversa sobre la red
    ...
    - $\frac{\partial ℓ_i}{\partial f_{k-1}} = \mathbb{I}[f_{k-1} >0] \odot \Omega_{k}^T \frac{\partial ℓ_i}{\partial f_k}$
    - Acá $\odot$ es la multiplicación punto por punto y $\mathbb{I}[f_{k-1} >0]$ es un vector con 1's donde $f_{k-1} >0$, 0 en todo lo demás
...
## Reduciendo la varianza     
![](../Imagenes/variance.png){fig-align="center" width="60%"}
...
## Reduciendo el sesgo
![](../Imagenes/sesgo.png){fig-align="center" width="60%"}



## ¿Qué pasa si reducimos el sesgo? overfitting 
- Más capacida describe mejor los ejemplos de entrenamiento pero no la función 

![](../Imagenes/overfitting.png){fig-align="center" width="60%"}



## Sesgo vs Varianza 
![](../Imagenes/biasvsvariance.png){fig-align="center" width="60%"}


## ¿Qué es double descent?

- La itución de ML básico nos dice que a + capacida + overfitting
- Esto no va a ser cierto con las redes (RF, ensambles)
- En está región el modelo se memoriza los datos de entrenamiento pero puede encontrar soluciones que generalizen 
...
![](../Imagenes/doubledescent.png){fig-align="center" width="60%"}
