...
## Encoder-Decoder 
![](../Imagenes/encoder-decoder.png){fig-align="center" width="75%"}
...
- Los pesos van a formar una combinación convexa si $\sum_{i} \alpha(q,k_i) = $ y $\alpha(q,k_i) \geq 0$, normalmente vamos a asumir esto
...
| **Uso pratico**     | Base del mecanismo de atención                   | Núcleo de los Transformers modernos                         |
...
- Intuicion: similar a dar coordenadas a cada palabra en la secuencia.
