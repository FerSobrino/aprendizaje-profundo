...
- Herramientas **post-hoc** (explican una predicción sin abrir el modelo):
    ...
    - Saliencia / Grad-CAM: qué pixeles movieron la decisión de una CNN
...
- La agenda nueva: en vez de aproximar por fuera, **abrir el modelo** y buscar los cómputos internos
...
- Y un corolario importante para agentes: la cadena de razonamiento que el modelo *escribe* no siempre refleja el cómputo real (CoT no siempre es fiel)
