...
## Intuición general de las funciones de perdida
...
# Etica en Aprendizaje profundo     


## Historia de la Etica en DL
...
- Idealmenete quisiéramos que los valores de los sistemas de AI se alineen con los de la humanidad 
...
1. Transparencia funcional: conocer el funcionamiento algorítmico del sistema 2. Transparencia estructural: sabemos como un programa ejecuta el algoritmo 
...
- Face recognition: por ejemplo usar fotos obtenidas sin consentimiento para para hacer frenología
- Militarización: cyber ataques, campañas de desinformación, drones autónomos
- Fraude: mails de pishing mas convincentes, deep fakes, chatbots que parecen humanos y solo quieren tu información 
...
- Ni los científicos ni los programadores existen en un vació, sus valores se filtran a sus algoritmos/modelos/apps
