...
## ¿Qué necesitamos para entrenar un algorítmos de ML? 
...
2. que la distribucion condicional P(y_i|x_i) de cada  output dado el input son independientesde de tal manera que podemos escribir la funcion de maxima verosimilitud de la siguiente manera: 
...
## Adaptive Momement Estimation (Adam)
