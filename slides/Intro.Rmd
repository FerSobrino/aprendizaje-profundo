...
![](../images/cat_dog_class.png){fig-align="center" width="80%"}
...
![](../images/IntroOverviewSideCap.png){fig-align="center" width="80%"}
...
- **ChatGPT / RLHF (2022)**: los LLMs se vuelven asistentes de propósito general — DL sale del laboratorio al público.
- **Modelos de razonamiento (2024)**: RL sobre problemas verificables; el modelo "piensa" más en los problemas difíciles.
- **Agentes (2025– )**: modelos que usan herramientas y completan tareas de varios pasos — los vamos a dirigir y auditar en este curso.
...
![](../images/IntroModels.png){fig-align="center" width="50%"}
...
![](../images/IntroAgeHeight.png){fig-align="center" width="80%"}
...
![](../images/IntroModels2a_compressed.png){fig-align="center" width="50%"}
...
![](../images/Unsupervised_Learning.png){fig-align="center" width="60%"}
